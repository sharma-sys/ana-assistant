...
class GoogleNewsCollector:
    ...
    def run(self) -> dict:
        logger.info("Starting Google News Collector run...")
        sources_to_process = self.db.query(NewsSource).filter(NewsSource.type == "google_news", NewsSource.is_active == True).all()
